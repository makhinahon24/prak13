...
public class MainActivity extends AppCompatActivity {
    ...
    Button applyBtn, lashBtn, nailBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lashBtn = findViewById(R.id.lash_btn);
        nailBtn = findViewById(R.id.nail_pic_btn);
        ...
        applyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Подтверждение записи")
                        .setMessage("Зай, ты точно придешь или как обычно?-_-")
                        .setIcon(R.drawable.ic_star)
                        .setPositiveButton("Да, точно", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dialogInterface.cancel();
                                Toast.makeText(MainActivity.this, "Ты записались, осталось еще прийти", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .setNegativeButton("Я спать", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        lashBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
